...
def main():
    ...
    orderitem1 = OrderItem(order="StarWars", productType="bookType",
                           price=22.50)
    orderitem2 = OrderItem(order="Avengers", productType="bookType",
                           price=35.50)
    orderitem3 = OrderItem(order="Spider-Man", productType="digitalType",
                           price=35.50)
